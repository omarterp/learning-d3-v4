...
import './chapter3/index-orig.js';
// import lifeExpectancyTable from './chapter2/index-orig.js';
...
function renderChart(data) {
  ...
  //     .classed('trippy', i % 2)
  //     .attr('transform', `translate(0, ${(i * 50) + charg.margin.top}`))
  //     .call(axis)
}
